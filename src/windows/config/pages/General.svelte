<script lang="ts">
    ...
    void trackConfigKeys(['app_language', 'app_theme', 'app_font', 'app_font_size', 'tray_click_event']);
...
<Section>
    ...
    <SettingRow label={t('config.general.app_theme')}>
        <PSelect value={cfg('app_theme')} items={themeItems} triggerClass="w-[160px]" onValueChange={onThemeChange} />
    </SettingRow>
