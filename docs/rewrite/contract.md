...
builtin allowlists openai / paddle,system,openai).
...
recognize openai = `instanceName, requestPath, model, apiKey, prompt`;
system/paddle are zero-config (legacy fields ignored).
